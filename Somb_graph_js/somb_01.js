        ...
        function delta(){
            ...
            for (let n = 0; n<pts; n++){
                ...
                for (let i = 0; i<pts; i++){  
                    ...
                    // Define variables
                    let nth = random(i - 1, i); // Assuming 'i' is predefined
                    let angle = nth * TWO_PI; // Convert 'nth' to an angle
                    let radius = 10; // Radius of the circle

                    // Calculate x, y, and z coordinates
                    let xn = sin(angle) * radius; // Calculate x-coordinate using cosine function
                    let yn = cos(angle) * radius; // Calculate y-coordinate using sine function
                    let zn = 0; // Set z-coordinate to 0 for a 2D circle in 3D space

                    // Draw the circle
                    plot.vertex(xn*10, yn*10, zn/2);
